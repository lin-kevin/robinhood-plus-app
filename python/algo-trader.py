...
def pairs_trading_algo():
    os.environ["APCA_API_BASE_URL"] = config.ALPACA_URL
    api = tradeapi.REST(config.ALPACA_API_KEY_ID, config.ALPACA_API_SECRET_KEY)
    account = api.get_account()

    sender_address = config.EMAIL_SENDER
    sender_pass = config.EMAIL_SENDER_PASSWORD
    receiver_address = config.EMAIL_RECEIVER
